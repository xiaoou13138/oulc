...
import com.ncu.table.bean.UserTypeDefineBean;
import com.ncu.util.beanUtil.BeanUtil;

@Repository
public class UserTypeDefineEngine{
  @Autowired
  BeanUtil beanUtil;
  public List queryByCondition(String condition , HashMap<String,String> params,int beginPage ,int endPage) throws Exception{
    return beanUtil.queryByCondition(condition, params, beginPage, endPage, UserTypeDefineBean.beanClass.getSimpleName());
  }
